...
// slots (browser tab, nav brand, hero headline/body) are real-fact-substitutable; every other
// section (logos, services, metrics, comparison, testimonials, faq) stays hand-authored example
// copy on purpose — there's no honest source for "this business's 12-year track record" or a real
// client quote, and fabricating one would be worse than an obvious placeholder.
export function corporateProfessionalStarterContent(business: StarterPageBusiness): PageContent {
  return {
    browser: {
      title: business.name,
    ...
    hero: {
      ...
      headline: business.tagline || 'Clear work. Reliable results.',
      body:
        business.description ||
        'We help businesses plan, deliver, and improve the work that matters — with honest scopes, real timelines, and people you can reach.',
      media: {
