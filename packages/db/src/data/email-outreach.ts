...
// slots substitute real facts; metrics/testimonials/faq stay hand-authored example copy — no
// honest source for real numbers or a real quote.
export function emailOutreachStarterContent(business: StarterPageBusiness): PageContent {
  return {
    browser: {
      title: `A short note from ${business.name}`,
    ...
    hero: {
      ...
      body:
        ...
        'Your work is already good. What’s usually missing is a simple system that gets the right people to see it, reply, and buy — one page, one message, one follow-up. No retainers dressed up as strategy.',
      media: {
