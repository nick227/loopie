...
describe('campaigns API', () => {
  it('runs CRUD lifecycle', async (ctx) => {
    ...
    try {
      if (!'/campaigns'.includes('{') || createdIds['campaigns']) {
        ...
        if (reslistCampaigns.statusCode !== 200) {
          console.error('listCampaigns failed with ' + reslistCampaigns.statusCode, reslistCampaigns.json().message || reslistCampaigns.json())
        }
    ...
    // Skipped createCampaign because payload could not be generated
    ...
    try {
      if (!'/campaigns/{campaignId}'.includes('{') || createdIds['campaigns']) {
        const resgetCampaignAuth = await app.inject({ method: 'GET', url: `/campaigns/${createdIds['campaigns'] || '00000000-0000-0000-0000-000000000001'}` })
    ...
    try {
      if (!'/campaigns/{campaignId}'.includes('{') || createdIds['campaigns']) {
        ...
        if (resgetCampaign.statusCode !== 200) {
          console.error('getCampaign failed with ' + resgetCampaign.statusCode, resgetCampaign.json().message || resgetCampaign.json())
        }
    ...
    try {
      if (!'/campaigns/{campaignId}'.includes('{') || createdIds['campaigns']) {
        const resupdateCampaignAuth = await app.inject({ method: 'PATCH', url: `/campaigns/${createdIds['campaigns'] || '00000000-0000-0000-0000-000000000001'}` })
    ...
    try {
      if (!'/campaigns/{campaignId}'.includes('{') || createdIds['campaigns']) {
        ...
        if (resupdateCampaign.statusCode !== 200) {
          console.error('updateCampaign failed with ' + resupdateCampaign.statusCode, resupdateCampaign.json().message || resupdateCampaign.json())
        }
    ...
    try {
      if (!'/campaigns/{campaignId}/pause'.includes('{') || createdIds['campaigns']) {
        const respauseCampaignAuth = await app.inject({ method: 'POST', url: `/campaigns/${createdIds['campaigns'] || '00000000-0000-0000-0000-000000000001'}/pause` })
    ...
    try {
      if (!'/campaigns/{campaignId}/pause'.includes('{') || createdIds['campaigns']) {
        ...
        if (respauseCampaign.statusCode === 201 && respauseCampaign.json().data?.id) createdIds['campaigns'] = respauseCampaign.json().data.id
        if (respauseCampaign.statusCode !== 200) {
          console.error('pauseCampaign failed with ' + respauseCampaign.statusCode, respauseCampaign.json().message || respauseCampaign.json())
        }
    ...
    try {
      if (!'/campaigns/{campaignId}/resume'.includes('{') || createdIds['campaigns']) {
        const resresumeCampaignAuth = await app.inject({ method: 'POST', url: `/campaigns/${createdIds['campaigns'] || '00000000-0000-0000-0000-000000000001'}/resume` })
    ...
    try {
      if (!'/campaigns/{campaignId}/resume'.includes('{') || createdIds['campaigns']) {
        ...
        if (resresumeCampaign.statusCode === 201 && resresumeCampaign.json().data?.id) createdIds['campaigns'] = resresumeCampaign.json().data.id
        if (resresumeCampaign.statusCode !== 200) {
          console.error('resumeCampaign failed with ' + resresumeCampaign.statusCode, resresumeCampaign.json().message || resresumeCampaign.json())
        }
    ...
    try {
      if (!'/campaigns/{campaignId}/end'.includes('{') || createdIds['campaigns']) {
        const resendCampaignAuth = await app.inject({ method: 'POST', url: `/campaigns/${createdIds['campaigns'] || '00000000-0000-0000-0000-000000000001'}/end` })
    ...
    try {
      if (!'/campaigns/{campaignId}/end'.includes('{') || createdIds['campaigns']) {
        ...
        if (resendCampaign.statusCode === 201 && resendCampaign.json().data?.id) createdIds['campaigns'] = resendCampaign.json().data.id
        if (resendCampaign.statusCode !== 200) {
          console.error('endCampaign failed with ' + resendCampaign.statusCode, resendCampaign.json().message || resendCampaign.json())
        }
    ...
    try {
      if (!'/campaigns/{campaignId}/duplicate'.includes('{') || createdIds['campaigns']) {
        const resduplicateCampaignAuth = await app.inject({ method: 'POST', url: `/campaigns/${createdIds['campaigns'] || '00000000-0000-0000-0000-000000000001'}/duplicate` })
    ...
    try {
      if (!'/campaigns/{campaignId}/duplicate'.includes('{') || createdIds['campaigns']) {
        ...
        if (resduplicateCampaign.statusCode === 201 && resduplicateCampaign.json().data?.id) createdIds['campaigns'] = resduplicateCampaign.json().data.id
        if (resduplicateCampaign.statusCode !== 201) {
          console.error('duplicateCampaign failed with ' + resduplicateCampaign.statusCode, resduplicateCampaign.json().message || resduplicateCampaign.json())
        }
    ...
    try {
      if (!'/campaigns/{campaignId}/performance'.includes('{') || createdIds['campaigns']) {
        const resgetCampaignPerformanceAuth = await app.inject({ method: 'GET', url: `/campaigns/${createdIds['campaigns'] || '00000000-0000-0000-0000-000000000001'}/performance` })
    ...
    try {
      if (!'/campaigns/{campaignId}/performance'.includes('{') || createdIds['campaigns']) {
        ...
        if (resgetCampaignPerformance.statusCode !== 200) {
          console.error('getCampaignPerformance failed with ' + resgetCampaignPerformance.statusCode, resgetCampaignPerformance.json().message || resgetCampaignPerformance.json())
        }
    ...
    try {
      if (!'/campaigns/{campaignId}/budget-authorizations'.includes('{') || createdIds['campaigns']) {
        const resauthorizeCampaignBudgetAuth = await app.inject({ method: 'POST', url: `/campaigns/${createdIds['campaigns'] || '00000000-0000-0000-0000-000000000001'}/budget-authorizations` })
  ...
  "idempotencyKey": "test_string"
        ...
        if (resauthorizeCampaignBudget.statusCode === 201 && resauthorizeCampaignBudget.json().data?.id) createdIds['campaigns'] = resauthorizeCampaignBudget.json().data.id
        if (resauthorizeCampaignBudget.statusCode !== 201) {
          console.error('authorizeCampaignBudget failed with ' + resauthorizeCampaignBudget.statusCode, resauthorizeCampaignBudget.json().message || resauthorizeCampaignBudget.json())
        }
    ...
    try {
      if (!'/campaigns/{campaignId}/funding'.includes('{') || createdIds['campaigns']) {
        const resgetCampaignFundingAuth = await app.inject({ method: 'GET', url: `/campaigns/${createdIds['campaigns'] || '00000000-0000-0000-0000-000000000001'}/funding` })
    ...
    try {
      if (!'/campaigns/{campaignId}/funding'.includes('{') || createdIds['campaigns']) {
        ...
        if (resgetCampaignFunding.statusCode !== 200) {
          console.error('getCampaignFunding failed with ' + resgetCampaignFunding.statusCode, resgetCampaignFunding.json().message || resgetCampaignFunding.json())
        }
    ...
    try {
      if (!'/campaigns/{campaignId}/leads'.includes('{') || createdIds['campaigns']) {
        const reslistCampaignLeadsAuth = await app.inject({ method: 'GET', url: `/campaigns/${createdIds['campaigns'] || '00000000-0000-0000-0000-000000000001'}/leads` })
    ...
    try {
      if (!'/campaigns/{campaignId}/leads'.includes('{') || createdIds['campaigns']) {
        ...
        if (reslistCampaignLeads.statusCode !== 200) {
          console.error('listCampaignLeads failed with ' + reslistCampaignLeads.statusCode, reslistCampaignLeads.json().message || reslistCampaignLeads.json())
        }
    ...
    try {
      if (!'/campaigns/{campaignId}/deployments'.includes('{') || createdIds['campaigns']) {
        const reslistDeploymentsAuth = await app.inject({ method: 'GET', url: `/campaigns/${createdIds['campaigns'] || '00000000-0000-0000-0000-000000000001'}/deployments` })
    ...
    try {
      if (!'/campaigns/{campaignId}/deployments'.includes('{') || createdIds['campaigns']) {
        ...
        if (reslistDeployments.statusCode !== 200) {
          console.error('listDeployments failed with ' + reslistDeployments.statusCode, reslistDeployments.json().message || reslistDeployments.json())
        }
    ...
    try {
      if (!'/deployments/{deploymentId}'.includes('{') || createdIds['deployments']) {
        const resgetDeploymentAuth = await app.inject({ method: 'GET', url: `/deployments/${createdIds['deployments'] || '00000000-0000-0000-0000-000000000001'}` })
    ...
    try {
      if (!'/deployments/{deploymentId}'.includes('{') || createdIds['deployments']) {
        ...
        if (resgetDeployment.statusCode !== 200) {
          console.error('getDeployment failed with ' + resgetDeployment.statusCode, resgetDeployment.json().message || resgetDeployment.json())
        }
    ...
    try {
      if (!'/deployments/{deploymentId}'.includes('{') || createdIds['deployments']) {
        const resupdateDeploymentAuth = await app.inject({ method: 'PATCH', url: `/deployments/${createdIds['deployments'] || '00000000-0000-0000-0000-000000000001'}` })
    ...
    try {
      if (!'/deployments/{deploymentId}'.includes('{') || createdIds['deployments']) {
        ...
        if (resupdateDeployment.statusCode !== 200) {
          console.error('updateDeployment failed with ' + resupdateDeployment.statusCode, resupdateDeployment.json().message || resupdateDeployment.json())
        }
