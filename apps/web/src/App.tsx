...
import { CreateAffiliatePage } from '@/pages/affiliates/CreateAffiliatePage'
import { AffiliateDetailPage } from '@/pages/affiliates/AffiliateDetailPage'
import { AffiliateClassesPage } from '@/pages/affiliates/AffiliateClassesPage'
import { AffiliatePayoutsPage } from '@/pages/affiliates/AffiliatePayoutsPage'
import { AffiliatePortalHomePage } from '@/pages/affiliates/AffiliatePortalHomePage'
import { AffiliatePortalTeamPage } from '@/pages/affiliates/AffiliatePortalTeamPage'
import { AffiliatePortalPayoutsPage } from '@/pages/affiliates/AffiliatePortalPayoutsPage'
