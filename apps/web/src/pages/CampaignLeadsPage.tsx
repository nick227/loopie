...
export function CampaignLeadsPage() {
  ...
  const leads = leadsQuery.data?.pages.flatMap((page) => page.data) ?? []
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-muted-foreground">Outcomes from this campaign. Open a contact to see the timeline.</p>
