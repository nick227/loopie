...
const fields: FieldConfig[] = [
  { name: 'stage', label: 'Stage', type: 'select', voice: false, required: false, options: ['NEW', 'CONTACTED', 'QUALIFIED', 'QUOTED', 'WON', 'LOST'] },
  { name: 'owner', label: 'Owner', type: 'text', voice: false, required: false },
  { name: 'estimatedValue', label: 'Estimated Value', type: 'number', voice: false, required: false },
]
