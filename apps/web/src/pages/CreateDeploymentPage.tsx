...
const fields: FieldConfig[] = [
  ...
  { name: 'platform', label: 'Platform', type: 'select', voice: false, required: true, options: ['META', 'GOOGLE', 'TIKTOK'] },
  { name: 'externalCampaignId', label: 'External Campaign Id', type: 'text', voice: false, required: false },
  { name: 'externalAdSetId', label: 'External Ad Set Id', type: 'text', voice: false, required: false },
