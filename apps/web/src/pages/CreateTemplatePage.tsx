...
const schema = z.object({
  ...
  personalizationTokens: z.preprocess((v) => (typeof v === 'string' ? v.split(',').map((s) => s.trim()).filter(Boolean) : v), z.array(z.string())).optional(),
...
const fields: FieldConfig[] = [
  ...
  { name: 'personalizationTokens', label: 'Personalization Tokens', type: 'tags', voice: false, required: false },
  { name: 'suggestedAudienceId', label: 'Suggested Audience Id', type: 'text', voice: false, required: false },
]
