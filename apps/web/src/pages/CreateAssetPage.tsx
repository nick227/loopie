...
const fields: FieldConfig[] = [
  { name: 'type', label: 'Type', type: 'select', voice: false, required: true, options: ['IMAGE', 'TEXT', 'VIDEO', 'AUDIO'] },
  { name: 'name', label: 'Name', type: 'text', voice: true, required: true },
  { name: 'url', label: 'Url', type: 'url', voice: false, required: false },
  { name: 'textContent', label: 'Text Content', type: 'textarea', voice: true, required: false, rows: 4 },
]
